        ...
        <div class="container-info">
            ...
            <div class="dataList">
                      <el-table  :data="tableData"  style="width: 100%">
                        <el-table-column prop="date" label="资源编号" > 
                          <template slot-scope="scope">
                                <div  @click="handleJoinPeople(scope.row)" >259855255 </div>
                          </template>
                        </el-table-column>
                          <el-table-column prop="date" label="核心服务能力" > 
                          <template slot-scope="scope">
                                <div  @click="handleJoinPeople(scope.row)" > 核心服务能力</div>
                          </template>
                        </el-table-column>
...
export default {
  ...
  data () {
    ...
    handleJoinPeople(data){
      this.$router.push({name:"shengqtxuDetail",query:{goodsId:this.goodsId}})
    }
