<template>
    <div style="min-height:200px;width:100%;margin:40px">
        <el-tabs v-model="activeName" style="height:50px">
            <el-tab-pane label="收件箱" name="first" ></el-tab-pane>
            <el-tab-pane label="发件箱" name="second" ></el-tab-pane>
        </el-tabs>
             ...
             <div class="dataList">
                      <el-table  :data="tableData"  style="width: 80%">
                        ...
                        <el-table-column  prop="data" label="状态"> 
                          <template slot-scope="scope">
                                <div  @click="handleJoinPeople(scope.row)" > 未读 </div>
                          </template>
                         </el-table-column>
