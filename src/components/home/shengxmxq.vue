              ...
              <div style="margin:15px auto;width:40%" class="">
                <el-input placeholder="请输入内容" v-model="input3" class="input-with-select">
                  <el-select v-model="select" slot="prepend" placeholder="请选择">
                    <el-option label="核心能力" value="1"></el-option> 
                  </el-select>
        ...
        <div class="container-info">
            ...
            <div class="dataList">
                      <el-table  :data="tableData"  style="width: 100%">
                        <el-table-column prop="date" label="技术资源编号" > 
                          <template slot-scope="scope">
                                <div  @click="handleJoinPeople(scope.row)" > {{scope.row.date}} </div>
                          </template>
                        </el-table-column>
                          <el-table-column prop="date" label="核心能力介绍" > 
                          <template slot-scope="scope">
                                <div  @click="handleJoinPeople(scope.row)" > 擅长加氢催化、管道反应及香精香料类产品</div>
                          </template>
                        </el-table-column>
...
export default {
  ...
  data () {
    ...
    handleJoinPeople(data){
      this.$router.push({name:"shengxmxqDetail",query:{goodsId:this.goodsId}})
    }
